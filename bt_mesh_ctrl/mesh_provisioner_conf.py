...
class MeshProvisionerConf:
    ...
    def _parse(self, data):
        ...
        self._appkeys = [appkey[JSON_INDEX] for appkey in data.get(JSON_APP_KEYS, ())]
    ...
    def get_provisioners_num(self) -> MeshCfgProvisioner:
        return len(self._provisioners)

    def get_provisioner(self, idx: int) -> MeshCfgProvisioner:
